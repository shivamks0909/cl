...
export const SECURITY_HEADERS = {
  ...
  // HSTS: 2 years with preload, only for HTTPS (set in middleware conditionally)
  'Referrer-Policy': 'strict-origin-when-cross-origin',
  // Permissions Policy: disable all sensors and features
  'Permissions-Policy': 'geolocation=(), microphone=(), camera=(), magnetometer=(), gyroscope=(), accelerometer=(), ambient-light-sensor=()'
};
